        ...
        <CardView color="white" margin="10" elevation="40" radius="2">
          <GridLayout rows="90, auto, auto" columns="auto, auto, *">
            ...
            <FlexboxLayout alignItems="flex-start" marginTop="-30" class="ratingsLayout">
              ...
              <Label fontSize="14" textWrap="true" textAlignment="center" padding="25" :text="$store.state.movieDetails.imdbRatings" width="70" height="65" marginRight="20" marginLeft="25" marginTop="50" class="info" row="1" colSpan="3"
                style="background-image: url('~/assets/images/star.png');  background-repeat: no-repeat; background-position: center; background-size: cover;" />
              <Label fontSize="17" textAlignment="center" padding="20" textWrap="true" :text="$store.state.movieDetails.metaScore" width="70" height="65" marginRight="20" marginLeft="15" marginTop="50" backgroundColor="#66cc33" class="info" row="1"
                colSpan="3" />
              <Label fontSize="14" textWrap="true" textAlignment="center" padding="25" :text="$store.state.movieDetails.rottenTomatoesRating" width="70" height="70" marginRight="25" marginLeft="15" marginTop="50" class="info" row="1" colSpan="3"
                style="background-image: url('~/assets/images/tomate.png');  background-repeat: no-repeat; background-position: center; background-size: cover;" />
